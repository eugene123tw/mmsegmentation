...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.attn = Attention(hidden_size, args.num_heads,
                              args.attention_drop_rate)
...
class TransUnetEncoderWrapper(nn.Module):
    ...
    def __init__(self, backbone, args):
        ...
        patch_size = (img_size[0] // stride // grid_size[0],
                      img_size[1] // stride // grid_size[1])
        patch_size_real = (patch_size[0] * stride, patch_size[1] * stride)
        num_patches = (img_size[0] // patch_size_real[0]) * (
    ...
    def forward(self, x):
        ...
        out = self.patch_embeddings(
            features[-1])  # (B, hidden. n_patches^(1/2), n_patches^(1/2))
        out = out.flatten(2)
